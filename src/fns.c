...
{
  if (FLOATP (obj1) || BIGNUMP (obj1) || BIGNUMP (obj2))
		...
		int depth, Lisp_Object ht)
{
 tail_recurse:
  ...
  if (INTEGERP (o1) && BIGNUMP (o2))
    return mpz_cmp_si (XBIGNUM (o2)->value, XINT (o1)) == 0;
  else if (BIGNUMP (o1) && INTEGERP (o2))
    return mpz_cmp_si (XBIGNUM (o1)->value, XINT (o2)) == 0;
